...
const gameList = [
  {
    name: "Tic Tac Toe",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Vel elit scelerisque mauris pellentesque pulvinar pellentesque.",
  },
  {
    name: "Connect Four",
    description:
      "Dictumst vestibulum rhoncus est pellentesque. Habitasse platea dictumst quisque sagittis purus sit amet volutpat consequat. Volutpat consequat mauris nunc congue. Convallis a cras semper auctor neque.",
  },
  {
    name: "Rock Paper Scissors",
    description:
      "Quis auctor elit sed vulputate mi sit amet mauris commodo. Duis ut diam quam nulla. Nunc non blandit massa enim nec. Duis convallis convallis tellus id interdum velit laoreet id donec.",
  },
];
